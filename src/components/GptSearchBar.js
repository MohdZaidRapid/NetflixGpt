...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    const gptQuery =
      ...
      ". only give me name of 5 movies,comma seperated like the example result ahead. Example Result: Gadar ,Sholay , Don, Golmaal, Koi Mil Gaya ";
    ...
    // for each movie  it will search Tmdb API
